...
#define ADD_PARSER_ENUM_VALUE(NAME) if(PyModule_AddIntConstant(module,#NAME,PyHP_API_StatementType_##NAME)!=0){return NULL;}
...
#define ADD_COMPILER_ENUM_VALUE(NAME) if(PyModule_AddIntConstant(module,#NAME,PyHP_API_PageCodeType_##NAME)!=0){return NULL;}
